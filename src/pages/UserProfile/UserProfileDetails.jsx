...
const BASE_FILE_URL = "http://localhost:5004/public/"; // Files served at /public/
...
const UserProfile = () => {
  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif", background: "#f9f9f9", minHeight: "100vh" }}>
      ...
      {/* DOCUMENTS - NEW IMPROVED VERSION */}
      <div style={{ marginBottom: "40px" }}>
        <div style={{
          background: "#f3f3f3",
          padding: "12px 20px",
...
const DocItem = ({ doc, downloadFile, downloading, downloaded }) => {
  const fileName = doc.documentImage.split(/[/\\]/).pop();

  const relativePath = doc.documentImage
    .replace(/\\/g, "/")
    .replace(/^public\//, "");

  const url = BASE_FILE_URL + relativePath;
