...
//       setTimeout(() => setDownloadedFile(null), 3000); // Clear success message
//     } catch (err) {
...
//             {g.installationBy?.length > 0 && g.installationBy.map((inst, i) => (
...
//       {/* DOCUMENTS - FIXED & MULTIPLE IMAGES SUPPORT */}
//       <div style={{ marginBottom: "40px" }}>
//         <div style={{ background: "#f3f3f3", padding: "12px 20px", borderRadius: "8px", marginBottom: "20px" }}>
...
//         {docs.length === 0 ? (
//           <p style={{ color: "#777", fontStyle: "italic", textAlign: "center", padding: "40px 0", background: "#fff", borderRadius: "8px", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
//             No documents uploaded
//           </p>
//         ) : (
//           <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", justifyContent: "flex-start" }}>
//             {docs.map((doc, docIndex) => {
//               // Normalize documentImage to always be an array
...
//               return (
//                 <div key={doc._id || docIndex} style={{ marginBottom: "30px" }}>
//                   <h3 style={{ fontSize: "18px", fontWeight: "bold", color: "#1976d2", marginBottom: "12px" }}>
//                     {doc.documentType || "Document"}
//                   </h3>
//                   {images.length === 0 ? (
//                     <p style={{ color: "#999", fontStyle: "italic" }}>No files uploaded</p>
//                   ) : (
//                     <div style={{ display: "flex", flexWrap: "wrap", gap: "15px" }}>
//                       {images.map((imgPath, imgIndex) => {
//                         const cleanPath = imgPath.replace(/\\/g, "/").replace(/^public\//, "");
//                         const url = BASE_FILE_URL + cleanPath;
//                         const fileName = cleanPath.split("/").pop() || `file-${imgIndex + 1}`;
...
// // Single Document File Item (Image or File)
// const DocItem = ({ url, fileName, isImage, downloadFile, downloading, downloaded }) => {
//   return (
//     <div style={{
//       background: "#fff",
//       padding: "12px",
...
//           onError={(e) => {
//             e.target.src = "https://via.placeholder.com/180x140?text=Image+Not+Found";
//           }}
//         />
//       ) : (
//         <div style={{
...
//       <p style={{ margin: "8px 0 4px", fontSize: "13px", color: "#555", wordBreak: "break-all" }}>
//         {fileName}
//       </p>
...
//       {downloaded === fileName && (
//         <p style={{ color: "green", fontSize: "12px", marginTop: "6px" }}>Downloaded!</p>
//       )}
//     </div>
//   );
// };
