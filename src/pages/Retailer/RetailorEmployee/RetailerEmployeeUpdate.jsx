...
// import { getEmployeeDetails, updateEmployee } from "../../../service/retailerEmployee";

// export default function ResellerEmployeeUpdate() {
//   const navigate = useNavigate();
//   const {lcoId: retailerId, empId } = useParams();
...
//       setLoading(true);
//       try {
//         const data = await getEmployeeDetails(retailerId, empId);
//         setFormData({
...
//     setLoading(true);
//     try {
//       await updateEmployee(retailerId, empId, formData);
//       toast.success("Employee updated successfully ✅");
//       // navigate(`/retailer/employee/list/${retailerId}`);
//       navigate(`/retailer/list/${retailerId}`);
//     } catch (err) {
...
//           <button
//             type="button"
//             onClick={() => navigate(`/retailer/list/${retailerId}`)}
...
export default function ResellerEmployeeUpdate() {
  ...
  // ✅ Fetch employee details (with pre-filled password)
  useEffect(() => {
    const loadEmployee = async () => {
      setLoading(true);
      try {
        ...
        setFormData({
          ...
          password: emp?.plainPassword || "", // ✅ pre-fill password
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`border p-2 w-full rounded ${
              errors.employeeUserName ? "border-red-500" : ""
            }`}
          />
          {errors.employeeUserName && (
            <p className="text-red-500 text-sm">{errors.employeeUserName}</p>
