...
import { MdOutlineAccountBalanceWallet, MdOutlineAssignment, MdOutlineSupportAgent } from "react-icons/md";
            ...
            <table className="min-w-[800px] w-full border border-gray-200 divide-y divide-gray-200 text-[14px]">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className="px-[2px] py-[0px] text-left ">Reseller Name</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {retailers.map((retailer, index) => (
                  <tr key={retailer._id} className="hover:bg-gray-50 relative">
                    ...
                    <td className="px-[2px] py-[0px] hover:cursor-pointer hover:underline" onClick={() => handleView(retailer._id)}>{retailer.resellerName}</td>
                    <td className="px-[2px] py-[0px]">{retailer.mobileNo}</td>
                    <td className="px-[2px] py-[0px]">{retailer.state}</td>
                    <td className="px-[2px] py-[0px]">{retailer.email || "—"}</td>
